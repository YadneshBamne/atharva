...
export default function LoginForm() {
  ...
  return (
    <div className="grid place-items-center h-screen bg-purple-200">
      <div className="shadow-lg p-5 rounded-lg border-t-4 border-purple-500">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 rounded-full text-black">
          ...
          />
          <button className="bg-purple-500 rounded-full text-black font-bold cursor-pointer px-6 py-2">
